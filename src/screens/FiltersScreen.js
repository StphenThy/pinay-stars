...
const s = StyleSheet.create({
  ...
  header: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', paddingHorizontal: 20, paddingTop: 52, paddingBottom: 14, backgroundColor: colors.white, borderBottomWidth: 1, borderColor: colors.line },
  headerLink: { color: colors.rose, fontWeight: '700', fontSize: 14 },
  headerTitle: { fontFamily: fonts.serif, fontWeight: '700', fontSize: 20, color: colors.burgundy },
  body: { padding: 20, paddingBottom: 40 },
  sectionHead: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', marginTop: 18, marginBottom: 12 },
  sectionTitle: { fontFamily: fonts.serif, fontWeight: '700', fontSize: 20, color: colors.burgundy },
  wrap: { flexDirection: 'row', flexWrap: 'wrap' },
  chipWrap: { marginRight: 8, marginBottom: 8 },
  radio: { flexDirection: 'row', alignItems: 'center', backgroundColor: colors.white, borderRadius: radius.md, paddingVertical: 13, paddingHorizontal: 14, marginBottom: 8, borderWidth: 1, borderColor: colors.line },
  radioActive: { borderColor: colors.burgundy, backgroundColor: colors.blush },
  radioDot: { width: 20, height: 20, borderRadius: 10, borderWidth: 2, borderColor: colors.muted, alignItems: 'center', justifyContent: 'center', marginRight: 12 },
  radioDotActive: { borderColor: colors.burgundy },
  radioInner: { width: 10, height: 10, borderRadius: 5, backgroundColor: colors.burgundy },
  radioLabel: { flex: 1, color: colors.textStrong, fontSize: 14, fontWeight: '600' },
  radioLabelActive: { color: colors.burgundy },
  radioTag: { color: colors.rose, fontWeight: '700', fontSize: 11, backgroundColor: colors.blushDeep, borderRadius: radius.pill, paddingHorizontal: 8, paddingVertical: 3, overflow: 'hidden' },
  ...
  curators: { marginTop: 26, backgroundColor: colors.burgundy, borderRadius: radius.lg, padding: 18 },
  curatorsTitle: { color: colors.white, fontWeight: '700', fontSize: 15, marginTop: 6 },
  curatorsBody: { color: '#FBD5D9', fontSize: 13, marginTop: 4 },
  footer: { padding: 20, paddingBottom: 28, backgroundColor: colors.white, borderTopWidth: 1, borderColor: colors.line },
  footerCount: { textAlign: 'center', color: colors.text, fontSize: 13, marginBottom: 10 },
});
