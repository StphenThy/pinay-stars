...
const s = StyleSheet.create({
  ...
  titleCompact: { fontSize: 22, marginTop: 4 },
  ...
  backText: { color: colors.onDarkSoft, fontWeight: '700', fontSize: 16 },
  topKicker: { color: colors.onDarkSoft, fontSize: 11, fontWeight: '700', letterSpacing: 1.8 },
  ...
  title: { fontFamily: fonts.serif, fontWeight: '700', fontSize: 28, color: colors.onDarkSoft, marginTop: 12, textAlign: 'center' },
  lead: { color: colors.onDarkSoft, fontSize: 13, lineHeight: 19, marginTop: 8, textAlign: 'center' },
  ...
  error: { color: colors.danger, fontWeight: '600', fontSize: 13, marginBottom: 12 },
