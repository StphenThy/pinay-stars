...
const makeStyles = ({ colors, shadow }) => StyleSheet.create({
  ...
  backButton: { width: 70, paddingVertical: 8, flexDirection: 'row', alignItems: 'center' },
  backText: { color: colors.onDarkSoft, fontFamily: fonts.sansBold, fontSize: 15 },
  topKicker: { color: colors.onDarkSoft, fontSize: 11, fontFamily: fonts.sansBold, letterSpacing: 1.8 },
  logo: { width: 64, height: 64, borderRadius: radius.lg, backgroundColor: colors.white, alignItems: 'center', justifyContent: 'center', overflow: 'hidden' },
  logoImage: { width: 64, height: 64 },
  title: { fontFamily: fonts.serif, fontSize: 24, color: colors.onDarkSoft, marginTop: 10, textAlign: 'center' },
  lead: { color: colors.onDarkSoft, fontFamily: fonts.sans, fontSize: 13, lineHeight: 18, marginTop: 4, textAlign: 'center', maxWidth: 300 },
  // One centred column so the tabs, form and switch card share a width; capped on tablets.
