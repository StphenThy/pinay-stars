...
const makeStyles = ({ colors, shadow }) => StyleSheet.create({
  ...
  hint: { color: colors.muted, fontFamily: fonts.sans, fontSize: 12, marginTop: 8, lineHeight: 17 },
  error: { color: colors.danger, fontSize: 12, marginTop: 8, fontFamily: fonts.sansSemi },
  ...
  headshotNote: { color: colors.muted, fontFamily: fonts.sans, fontSize: 12, marginTop: 8 },
  counter: { alignSelf: 'flex-end', color: colors.muted, fontFamily: fonts.sans, fontSize: 12, marginTop: 8 },
  chips: { flexDirection: 'row', flexWrap: 'wrap' },
  chipWrap: { marginRight: 8, marginBottom: 8 },
  formError: { marginHorizontal: 20, color: colors.danger, fontFamily: fonts.sansSemi, fontSize: 13, textAlign: 'center' },
  formNote: { marginHorizontal: 20, color: colors.muted, fontFamily: fonts.sans, fontSize: 12, textAlign: 'center' },
  actions: { marginHorizontal: 20, marginTop: 12 },
  cancel: { alignItems: 'center', paddingVertical: 12 },
  cancelText: { color: colors.rose, fontFamily: fonts.sansBold, fontSize: 13 },
  footnote: { marginHorizontal: 32, color: colors.muted, fontFamily: fonts.sans, fontSize: 12, textAlign: 'center', lineHeight: 18 },
});
