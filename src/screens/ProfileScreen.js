...
const makeStyles = ({ colors, type, shadow }) => StyleSheet.create({
  ...
  back: { color: colors.rose, fontSize: 16, fontFamily: fonts.sansBold },
  header: { fontFamily: fonts.serif, fontSize: 22, color: colors.burgundy },
  ...
  ratingBig: { fontFamily: fonts.serif, fontSize: 36, color: colors.burgundy, marginRight: 12, minWidth: 56, textAlign: 'center' },
  ratingCount: { color: colors.text, fontFamily: fonts.sans, fontSize: 12, marginTop: 4 },
  rateHint: { flexDirection: 'row', alignItems: 'center', marginTop: 12 },
  rateHintText: { color: colors.burgundy, fontFamily: fonts.sansBold, fontSize: 13, marginLeft: 8 },
  adminNote: { color: colors.muted, fontFamily: fonts.sans, fontSize: 12, marginTop: 12 },
  ...
  mineTitle: { color: colors.burgundy, fontFamily: fonts.sansBold, fontSize: 13 },
  mineComment: { color: colors.textStrong, fontFamily: fonts.sans, fontSize: 13, lineHeight: 20, marginTop: 8 },
  mineActions: { flexDirection: 'row', marginTop: 12 },
  reviewInput: { marginTop: 12, minHeight: 72, backgroundColor: colors.background, borderWidth: 1, borderColor: colors.line, borderRadius: radius.md, paddingHorizontal: 12, paddingVertical: 12, fontFamily: fonts.sans, fontSize: 13, color: colors.textStrong, textAlignVertical: 'top' },
  ...
  reviewName: { color: colors.textStrong, fontFamily: fonts.sansBold, fontSize: 13 },
  reviewTime: { color: colors.muted, fontFamily: fonts.sans, fontSize: 11 },
  reviewComment: { color: colors.text, fontFamily: fonts.sans, fontSize: 13, lineHeight: 20, marginTop: 8 },
  removeLink: { marginTop: space.xs, alignSelf: 'flex-start', minHeight: 36, justifyContent: 'center' },
  removeLinkText: { color: colors.danger, fontSize: 12, fontFamily: fonts.sansBold },
  ...
  legal: { color: colors.onDarkSoft, fontFamily: fonts.sans, fontSize: 13, marginTop: 12 },
  tagline: { color: colors.white, fontSize: 13, marginTop: 8, fontFamily: fonts.sansSemi },
  detail: { color: colors.onDarkSoft, fontFamily: fonts.sans, fontSize: 13, lineHeight: 20, marginTop: 8 },
  ratingRow: { flexDirection: 'row', alignItems: 'baseline', marginTop: 8 },
  reviews: { color: colors.onDarkSoft, fontSize: 12, marginLeft: 8, fontFamily: fonts.sansSemi },
  recordId: { color: colors.white, fontFamily: fonts.sansBold, fontSize: 12, letterSpacing: 1, backgroundColor: 'rgba(50,0,15,0.55)', borderRadius: radius.pill, paddingHorizontal: 12, paddingVertical: 4, overflow: 'hidden' },
  ...
  pendingTitle: { color: colors.warning, fontFamily: fonts.sansBold, fontSize: 15 },
  ...
  metricValue: { fontFamily: fonts.serif, fontSize: 18, color: colors.burgundy },
  metricLabel: { fontFamily: fonts.sans, fontSize: 11, color: colors.text, textAlign: 'center', marginTop: 4 },
  tags: { flexDirection: 'row', flexWrap: 'wrap' },
  note: { backgroundColor: colors.blush, borderRadius: radius.md, padding: 12, marginTop: 12 },
  noteTitle: { color: colors.burgundy, fontSize: 13, fontFamily: fonts.sansBold },
  noteText: { color: colors.text, fontFamily: fonts.sans, fontSize: 13, marginTop: 4 },
  ...
  listSub: { color: colors.rose, fontFamily: fonts.sans, fontSize: 12, marginTop: 4 },
  emptyRow: { color: colors.muted, fontFamily: fonts.sans, fontSize: 13 },
  recordMeta: { flexDirection: 'row', justifyContent: 'space-between', marginTop: 16, paddingHorizontal: 4 },
  recordMetaText: { color: colors.muted, fontFamily: fonts.sans, fontSize: 12 },
});
